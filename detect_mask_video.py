...
def change_pass():
    ...
    lbl6 = tk.Label(master, text='Confirm New qSSSPassword', bg='white', font=('times', 12, ' bold '))
...
message3 = tk.Label(window, text="Face Mask Detection Based Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
